...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User LoggedInUser= userLoggedInService.getLogedInUser();
        ...
        return LoggedInUser.getForTests();
        ...
        throw new ResponseStatusException(HttpStatus.INITIATED,"Request Successful"); // replace this line with your code
