...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        throw new ResponseStatusException(HttpStatus.LAB_TEST_ASSIGNED,"Request Initiatated");
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        return LoggedInUser.getForConsultations();
        ...
        // replace this line of code with your implementation
        throw new ResponseStatusException(HttpStatus.Status_Initiated,"Successful");
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        TestRequest testRequest= new TestRequest();
         return testRequest.testRequestUpdateService.assignForConsultation(LoggedInUser,id);
        // return the above created object
        // For reference check the method assignForLabTest() method from LabRequestController class
        try {
            // replace this line of code with your implementation
            throw new ResponseStatusException(HttpStatus.Status_Initiated,"Request Successful");
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        TestRequest testRequest= new TestRequest();
        return testRequest.testRequestUpdateService.updateConsultation(LoggedInUser,id,testRequest);
        ...
        try {
            // replace this line of code with your implementation
            throw new ResponseStatusException(HttpStatus.REQUEST_INITIATED,"Resquest Successful");
